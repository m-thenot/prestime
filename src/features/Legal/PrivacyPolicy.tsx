    ...
    <div className="container">
      ...
      <div className="max-w-2xl mx-auto my-5 sm:my-10">
        ...
        <p>
          ...
          EasyService, qui fournit également les raisons pour lesquelles nous
          ...
          d&lsquo;utiliser le site web de EasyService.
        </p>
        ...
        <p>
          Lorsque vous visitez le EasyService, nous recueillons automatiquement
